...
#region Material
        ...
        public static Sequence DOGradientColor(
            this Material target, Gradient gradient, float duration
        )
        {
        ...
        /// </param>
        public static Sequence DOGradientColor(
            this Material target, Gradient gradient, string property,
            float duration
        )
        {
            var s = DOTween.Sequence();
            ...
            for (var i = 0; i < len; ++i)
            {
                ...
                var colorDuration = i == len - 1 ?
                    ...
                    duration * (i == 0 ? c.time : c.time - colors[i - 1].time);
                s.Append(
                    target.DOColor(c.color, property, colorDuration)
                        .SetEase(Ease.Linear)
                );
            }
            s.SetTarget(target);
...
#region CustomYieldInstructions
        /// <summary>
        ///     Returns a <see cref="CustomYieldInstruction"/> that waits until the tween
        ///     is killed or complete.
        ...
        public static CustomYieldInstruction WaitForCompletion(
            this Tween t, bool returnCustomYieldInstruction
        )
        {
            if (!t.active)
            {
        ...
        /// <summary>
        ///     Returns a <see cref="CustomYieldInstruction"/> that waits until the tween
        ///     is killed or has gone through the given amount of loops.
        ///     It can be used inside a coroutine as a yield.
        ///     <para>
        ///         Example usage:
        ///     </para>
        ...
        /// </summary>
        /// <param name="elapsedLoops">
        ///     Elapsed loops to wait for
        /// </param>
        public static CustomYieldInstruction WaitForElapsedLoops(
            this Tween t, int elapsedLoops, bool returnCustomYieldInstruction
        )
        {
            if (!t.active)
            {
            ...
            return new DOTweenCYInstruction.WaitForElapsedLoops(
                t, elapsedLoops
            );
        }
        ...
        public static CustomYieldInstruction WaitForPosition(
            this Tween t, float position, bool returnCustomYieldInstruction
        )
        {
            if (!t.active)
            {
        ...
        /// <summary>
        ///     Returns a <see cref="CustomYieldInstruction"/> that waits until the tween
        ///     is killed or started
        ///     (meaning when the tween is set in a playing state the first time, after any
        ///     eventual delay).
        ///     It can be used inside a coroutine as a yield.
        ///     <para>
        ///         Example usage:
...
#region Material
        /// <summary>
        ///     Tweens a Material's named texture offset property with the given ID to the
        ///     given value.
        ///     Also stores the material as the tween's target so it can be used for
        ///     filtered operations
        /// </summary>
        /// <param name="endValue">
        ...
        ///     The ID of the material property to tween (also called nameID in Unity's
        ///     manual)
        /// </param>
        /// <param name="duration">
        ///     The duration of the tween
        ...
        public static TweenerCore<Vector2, Vector2, VectorOptions> DOOffset(
            this Material target, Vector2 endValue, int propertyID,
            float duration
        )
        {
        ...
        /// <summary>
        ///     Tweens a Material's named texture scale property with the given ID to the
        ///     given value.
        ///     Also stores the material as the tween's target so it can be used for
        ///     filtered operations
        /// </summary>
...
#region Async Instructions
        /// <summary>
        ///     Returns an async <see cref="System.Threading.Tasks.Task"/> that waits until
        ///     the tween is killed or complete.
        ...
        /// <summary>
        ///     Returns an async <see cref="System.Threading.Tasks.Task"/> that waits until
        ///     the tween is killed or rewinded.
        ///     It can be used inside an async operation.
        ///     <para>
        ///         Example usage:
        ///     </para>
        ...
        public static async Task AsyncWaitForRewind(this Tween t)
        {
            ...
            while (t.active && (!t.playedOnce
                                || t.position * (t.CompletedLoops() + 1) > 0))
            {
                await Task.Yield();
            }
        }
        ...
        /// <summary>
        ///     Returns an async <see cref="System.Threading.Tasks.Task"/> that waits until
        ///     the tween is killed or has gone through the given amount of loops.
        ///     It can be used inside an async operation.
        ///     <para>
        ///         Example usage:
        ///     </para>
        ...
        ///     Elapsed loops to wait for
        /// </param>
        public static async Task AsyncWaitForElapsedLoops(
            this Tween t, int elapsedLoops
        )
        {
            if (!t.active)
            {
        ...
        /// <summary>
        ///     Returns an async <see cref="System.Threading.Tasks.Task"/> that waits until
        ///     the tween is killed or started
        ///     (meaning when the tween is set in a playing state the first time, after any
        ///     eventual delay).
        ///     It can be used inside an async operation.
        ///     <para>
        ...
        ///     Position (loops included, delays excluded) to wait for
        /// </param>
        public static async Task AsyncWaitForPosition(
            this Tween t, float position
        )
        {
            if (!t.active)
            {
    ...
    public static class DOTweenCYInstruction
    {
        ...
        {
            public override bool keepWaiting =>
                t.active && t.CompletedLoops() < elapsedLoops;
            private readonly Tween t;

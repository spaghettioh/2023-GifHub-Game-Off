...
#region Reflection
        ...
        public static void Init()
        {
            ...
            _initialized = true;
            DOTweenExternalCommand.SetOrientationOnPath +=
                Physics.SetOrientationOnPath;
...
#pragma warning restore
        ...
        public static class Physics
        {
            ...
            public static void SetOrientationOnPath(
                PathOptions options, Tween t, Quaternion newRot, Transform trans
            )
            {
...
#region Called via Reflection
            ...
            [Preserve]
#endif
            public static TweenerCore<Vector3, Path, PathOptions>
                CreateDOTweenPathTween(
                    MonoBehaviour target, bool tweenRigidbody, bool isLocal,
                    Path path, float duration, PathMode pathMode
                )
            {

...
public class OldHUDManager : MonoBehaviour
{
    [Header("Progress")]
    [SerializeField]
    private TMP_Text _propCountText;
    ...
    [SerializeField]
    private IntEventSO _propsToWin;
    [SerializeField]
    private VoidEventSO _winCondition;
    [SerializeField]
    private VoidEventSO _loseCondition;

    [Header("Broadcasting to...")]
    [SerializeField]
    private BoolEventSO _pauseEvent;
    [SerializeField]
    private LoadSceneEventSO _loadEvent;
